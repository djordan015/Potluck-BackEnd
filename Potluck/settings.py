...
INSTALLED_APPS = [
    ...
    'Potluck.apps.MongoAdminConfig',
    'Potluck.apps.MongoAuthConfig',
    'Potluck.apps.MongoContentTypesConfig',
...
DATABASES = {
    'default': {
        ...
        'HOST' : f"{os.environ.get('MONGO_URI')}",
        'NAME': 'potluck',
    },
}
...
# Use ObjectId-compatible default primary key for MongoDB backend.
